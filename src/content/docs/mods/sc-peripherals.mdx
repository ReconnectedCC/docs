...
import poster_printer from '../../../assets/poster_printer.png';
...
#### sc-peripherals
- [sc-peripherals on GitHub](https://github.com/reconnectedcc/sc-peripherals)
...
<Image src={printer} alt="3D Printer" title="3D Printer"
...
<Image src={poster_printer} alt="Wide Format Printer" title="Wide Format Printer"
  style="float: right; margin-left: 16px" />
