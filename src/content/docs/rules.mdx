...
2.  ## Do not abuse system resources with malicious intent
    ...
    7.  Attempting to corrupt the world or chunkban yourself or another player by creating invalid items, blocks or network packets is not allowed.
        1.  Nesting containers is considered an invalid item and is not allowed.
            1. As an exception to this nesting-containers rule, placing Diamond Shulker Boxes inside a vanilla Shulker Box is explicitly allowed.
...
4.  ## Do not be a nuisance to other players
    ...
    14. Exploiting ingame player software over modem or physical interaction (monitor clicks / terminal access / disk drives) is allowed.
        ...
        6. Do not spoof or jam public use protocols with servers able to be independently hosted by anyone in the community in which a source of truth isn't unique or isn't reasonably accessible within the boundaries of CC.
            1. These protocols may include, but are not limited to: [ComputerCraft GPS](https://tweaked.cc/module/gps.html), Herr Katze's standard of ShopSync.
        7. Excessive, targetted exploiting of one player's software for the purpose of harassment is not allowed.
