...
4.  ## Do not be a nuisance to other players
    ...
    14. Exploiting ingame player software over modem or physical interaction (monitor clicks / terminal access / disk drives) is allowed.
        ...
        6. Do not spoof or jam public use protocols with servers able to be independently hosted by anyone in the community in which a source of truth isnt unique or isnt reasonably accessible within the boundaries of CC.
