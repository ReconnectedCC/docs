...
3.  ## Do not exploit bugs or cheat in any way
    ...
    2.  X-raying, wallhacking, player automation and similar hacks with texture packs or mods is not allowed. Plethora Block Scanners are allowed.
...
4.  ## Do not be a nuisance to other players
    ...
    14. Exploiting ingame player software over modem or physical interaction (monitor clicks / terminal access / disk drives) is allowed. This can be for the goal of software piracy or a proof of concept. Player software, config or data should *not* be removed outright.
        1. This can be for the goal of software piracy, a proof of concept or adding "points".
            1. When changing any value in a configuration or database, it should only be your own player data that is affected.
        2. Player software, databases, configuration or other files on a computer should not be removed outright.
        ...
        4. Exploiting a computer using malicious software is fine, but it should be non desctructive.
            1. The malicious software must have been uploaded through an exploit of player software
        5. Exploits of player software must not impact real life servers or computers.
