...
| `data`    | Table containing the full [Event packet](/chatbox/websocket#in-game-chat-event)                 |
...
| `message` | The full raw text of their message (including markdown characters)                                                                       |
| `data`    | Table containing the full [Event packet](/chatbox/websocket#discord-chat-event)                                                                |
...
| `data`    | Table containing the full [Event packet](/chatbox/websocket#chatbox-chat-event)                 |
...
| `data`    | Table containing the full [Event packet](/chatbox/websocket#command-event)                           |
...
| `data`  | Table containing the full [Event packet](/chatbox/websocket#join-event)              |
...
| `data`  | Table containing the full [Event packet](/chatbox/websocket#leave-event)           |
...
| `data`   | Table containing the full [Event packet](/chatbox/websocket#death-event)           |
...
| `data`        | Table containing the full [Event packet](/chatbox/websocket#world-change-event) |
...
| `data`  | Table containing the full [Event packet](/chatbox/websocket#afk-event)                 |
...
| `event` | `"afk_return"`                                                                   |
| `user`  | The username of the user that went AFK (or their UUID if they don't have a name) |
| `data`  | Table containing the full [Event packet](/chatbox/websocket#afk-return-event)          |
...
[Event packet](/chatbox/websocket#server-restart-scheduled-event).
...
| `data`    | Table containing the full [Event packet](/chatbox/websocket#server-restart-scheduled-event) |
...
| `type`  | The type of restart. Will be `"automatic"` or `"manual"`.                             |
| `data`  | Table containing the full [Event packet](/chatbox/websocket#server-restart-cancelled-event) |
...
Returns a table of [user objects](/chatbox/websocket#user-object) that are currently online in-game.
...
Returns the username and [user object](/chatbox/websocket#user-object) of the player that owns this chatbox license.
