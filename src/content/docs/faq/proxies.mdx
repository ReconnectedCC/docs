...
If you're having trouble connecting to the server, you can try using the Raknet protocol. This is a different protocol that can sometimes help with connection issues. To use it, add the server with the following address: `raknet://play.reconnected.cc`
